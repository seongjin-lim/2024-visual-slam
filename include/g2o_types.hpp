...
// for feature and camera pose bundle adjustment
...
// for camera pose and landmark pose bundle adjustment
class EdgeProjection
    : public g2o::BaseBinaryEdge<2, Vec2, VertexPose, VertexXYZ> {
public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW;

  // camera intrinsic and extrinsic parameter initialization
